...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(1)
      if (sym_ident_character_set_1(lookahead)) ADVANCE(110);
      END_STATE();
    case 2:
    ...
    case 45:
      ACCEPT_TOKEN(anon_sym_int);
      if (sym_ident_character_set_2(lookahead)) ADVANCE(110);
      END_STATE();
    case 46:
    ...
    case 85:
      ...
      if (sym_ident_character_set_3(lookahead)) ADVANCE(110);
      END_STATE();
    case 86:
      ACCEPT_TOKEN(sym_ident);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [34] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(57),
  ...
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 5),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 4),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 2),
  ...
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2), SHIFT_REPEAT(58),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2),
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 6),
  ...
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 4),
  ...
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_item, 7),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 3),
  ...
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1),
...
extern const TSLanguage *tree_sitter_nmet(void) {
